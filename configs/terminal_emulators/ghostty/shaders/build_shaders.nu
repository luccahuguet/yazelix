...
export def build_ghostty_cursor_effect_shaders [
    ...
    for effect in $effect_templates {
        ...
        let rendered = (render_ghostty_cursor_effect_shader $template_code $glow_level $color_source)
...
def main [
    ...
    build_ghostty_cursor_effect_shaders $shader_source_dir $glow_level $shader_output_dir $effect_color_literal
}
