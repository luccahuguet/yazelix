...
def render_ghostty_cursor_effect_shader [template_code: string] {
    $template_code
        | str replace -r 'vec4 COLOR = [^;]+;' "vec4 COLOR = iCurrentCursorColor;"
}
...
export def build_ghostty_cursor_effect_shaders [shader_dir: path] {
    ...
    for effect in $effect_templates {
        ...
        let rendered = (render_ghostty_cursor_effect_shader $template_code)
