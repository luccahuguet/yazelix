...
// Cosmic purple trail colors
// Main: vivid cosmic purple, Accent: deeper indigo glow
const vec4 TRAIL_COLOR = vec4(0.78, 0.38, 0.96, 1.0);      // ~#C764F5
const vec4 TRAIL_COLOR_ACCENT = vec4(0.47, 0.24, 0.86, 1.0); // ~#783DDC
const float DURATION = 0.28; // Slightly snappier than blaze
...
void mainImage(out vec4 fragColor, in vec2 fragCoord)
{
    ...
    float mod = .006;
    // Trail - cosmic purple glow layering
    ...
    // Cursor - brighter core with accent edge
