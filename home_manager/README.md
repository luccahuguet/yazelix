...
Ghostty cursor presets and effects live in `~/.config/yazelix_ghostty_cursors/settings.jsonc`. Set `programs.yazelix.manage_cursor_config = true` only when you want Home Manager to own that cursor registry.
