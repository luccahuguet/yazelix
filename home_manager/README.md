...
After Nova replaces the default branch, pin `yazelix.url = "github:luccahuguet/yazelix/v17.12";` while running this migration, launch the bridge once, then update the input to Nova
