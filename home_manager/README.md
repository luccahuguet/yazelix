...
- **Selects one packaged terminal** with Ghostty by default, Rio-compatible child package mode, WezTerm, and Kitty as alternates, Yazelix Terminal as the experimental Rio-derived path, and Foot/Ratty as Linux options through `terminal`
