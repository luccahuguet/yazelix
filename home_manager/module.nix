...
in {
  options.programs.yazelix = {
    ...
    cursor_trail = mkOption {
      type = types.enum [ "blaze" "snow" "cosmic" "ocean" "forest" "sunset" "neon" "party" "eclipse" "dusk" "orchid" "reef" "random" "none" ];
      default = "random";
      description = ''
        Cursor trail preset.
        Supported by all terminal emulators: "none"
        Supported by Ghostty: "blaze", "snow", "cosmic", "ocean", "forest", "sunset", "neon", "party", "eclipse", "dusk", "orchid", "reef", "random"
