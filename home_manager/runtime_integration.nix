...
let
  ...
  assertions = [
    ...
    {
      assertion = (componentEnabled "screen") || (cfg.manage_config && cfg.welcome_enabled == false);
      message = "programs.yazelix.components.screen = false requires manage_config = true and welcome_enabled = false";
    }
    {
      assertion = (runtimeToolSource "macchina") != "off" || (cfg.manage_config && cfg.welcome_enabled == false);
      message = "programs.yazelix.runtime_tool_sources.macchina = \"off\" requires manage_config = true and welcome_enabled = false";
    }
    {
