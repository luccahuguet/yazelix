...
fn widget_tray_question() -> MultiQuestion {
    multi_question(
        ...
        &[
            ...
            ("Codex daily usage", "codex_daily_usage"),
            ("Codex monthly usage", "codex_monthly_usage"),
            ("Codex session usage", "codex_session_usage"),
            ("OpenCode usage", "opencode_usage"),
            ("OpenCode daily usage", "opencode_daily_usage"),
            ("OpenCode monthly usage", "opencode_monthly_usage"),
            ("OpenCode session usage", "opencode_session_usage"),
            ("CPU", "cpu"),
            ("RAM", "ram"),
        ],
        &[
