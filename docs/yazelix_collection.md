...
- [sidebar_status.yazi](../configs/yazi/plugins/sidebar_status.yazi/main.lua) — Removes a space-hungry status item so Yazi fits cleanly as a sidebar. Yazelix-only plugin.
