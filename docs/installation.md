...
- **Terminal package**: choose a flake output such as `#yazelix`, `#yzxterm`, `#yazelix_wezterm`, `#yazelix_kitty`, or set Home Manager `programs.yazelix.terminal`
