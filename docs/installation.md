...
Use `#yazelix_wezterm` instead if you intentionally want the package-provided WezTerm runtime variant.
...
The default package is the Ghostty variant. To install the package-provided WezTerm variant explicitly:
