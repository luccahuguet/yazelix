...
- **Standalone Screen Animations**: Run `nix run github:luccahuguet/yazelix-screen#yzs` to preview the Yazelix screen animation engines outside Zellij and outside a Yazelix session. It supports boids, Mandelbrot, and Game of Life styles and exits on keypress.
