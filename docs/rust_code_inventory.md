...
| --- | ---: | ---: | --- | --- |
| Product runtime source | 95 | 51,251 | canonical and extension surfaces | High: contains the largest user-facing seams |
...
| Total | 163 | 72,664 | current budget ceiling | Reduce or extract before raising ceilings |
