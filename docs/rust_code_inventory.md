...
| --- | ---: | ---: | --- | --- |
| Product runtime source | 95 | 51,065 | canonical and extension surfaces | High: contains the largest user-facing seams |
...
| Total | 163 | 72,478 | current budget ceiling | Reduce or extract before raising ceilings |
...
| `core_config_ui_and_materialization` | 42 | 20,702 | 14,000 | Largest product family; config UI, apply modes, runtime component manifest, ratconfig boundary, materializers, settings surfaces |
