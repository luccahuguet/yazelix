...
| --- | ---: | ---: | --- | --- |
| Product runtime source | 84 | 51,359 | canonical and extension surfaces | High: contains the largest user-facing seams |
...
| Total | 146 | 72,773 | current budget ceiling | Reduce or extract before raising ceilings |
