...
| --- | ---: | ---: | --- | --- |
| Product runtime source | 79 | 51,273 | canonical and extension surfaces | High: contains the largest user-facing seams |
...
| Total | 141 | 73,143 | current budget ceiling | Reduce or extract before raising ceilings |
