...
| Product integration tests | 19 | 5,798 | canonical tests | Medium: split by behavior family, do not delete broadly |
...
| Total | 163 | 72,121 | current budget ceiling | Reduce or extract before raising ceilings |
...
| `core_integration_tests` | 19 | 5,798 | 4,500 | High-value tests, but several files are broad family buckets |
...
| `rust_core/yazelix_core/tests/yzx_core_config_normalize.rs` | 1,493 | Split by config/materialization behavior family; do not delete without replacement coverage |
