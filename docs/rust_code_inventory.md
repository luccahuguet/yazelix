...
| --- | ---: | ---: | --- | --- |
| Product runtime source | 95 | 51,008 | canonical and extension surfaces | High: contains the largest user-facing seams |
...
| Total | 163 | 72,421 | current budget ceiling | Reduce or extract before raising ceilings |
...
| `core_config_ui_and_materialization` | 42 | 20,653 | 14,000 | Largest product family; config UI, apply modes, runtime component manifest, ratconfig boundary, materializers, settings surfaces |
...
| `rust_core/yazelix_core/src/yazi_materialization/writer.rs` | 939 | Private Yazi writer; keep generic writer logic thin before any public extraction |
