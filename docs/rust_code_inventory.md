...
| Maintainer tooling and tests | 24 | 10,675 | canonical maintainer | Medium: keep in repo, but split large validator files |
| Pane orchestrator plugin | 25 | 4,841 | extension surface | High: already has a natural Zellij plugin boundary |
| Total | 163 | 72,032 | current budget ceiling | Reduce or extract before raising ceilings |
...
| `maintainer_tooling_and_validators` | 23 | 10,436 | 9,000 | Keep in repo; config-surface, upgrade-contract, installed-runtime, Nix interface, package/profile, and helper IO validators now have private domains |
