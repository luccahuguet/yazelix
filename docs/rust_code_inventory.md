...
| --- | ---: | ---: | --- | --- |
| Product runtime source | 95 | 51,184 | canonical and extension surfaces | High: contains the largest user-facing seams |
...
| Total | 163 | 72,597 | current budget ceiling | Reduce or extract before raising ceilings |
