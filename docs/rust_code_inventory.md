...
| `rust_core/yazelix_core/src/config_ui/model_builder.rs` | 912 | Yazelix config UI model adapter | Keep Yazelix schema, ownership, validation, and persistence local while generic UI mechanics stay in `ratconfig` |
