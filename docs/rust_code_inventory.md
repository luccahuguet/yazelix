...
| --- | ---: | ---: | --- | --- |
| Product runtime source | 95 | 50,967 | canonical and extension surfaces | High: contains the largest user-facing seams |
...
| Total | 163 | 72,304 | current budget ceiling | Reduce or extract before raising ceilings |
