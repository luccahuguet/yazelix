...
| `zellij.popup_program` | `generated_runtime_refresh` | Applied to generated `yzpp` popup specs and active only after the generated Zellij config is refreshed and Yazelix restarts |
