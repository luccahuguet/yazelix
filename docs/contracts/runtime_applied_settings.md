...
| `zellij.popup_program`, `zellij.popup_commands` | `tab_session_restart` | Applied to generated `yzpp` popup specs and active only after the generated Zellij config is refreshed and Yazelix restarts |
