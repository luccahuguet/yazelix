...
- manual verification: review `maintainer_shell.nix`, `settings_default.jsonc`, `home_manager/module.nix`, and the documented packs against this policy
...
## Traceability
- Defended by: `manual review of maintainer_shell.nix, settings_default.jsonc, and home_manager/module.nix against this policy`
