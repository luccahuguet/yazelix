...
- The packaged runtime has one terminal: Mars, exposed through `yazelix`, `yazelix_mars`, `runtime`, and `runtime_mars`. Home Manager installs the complete Yazelix package by default.
