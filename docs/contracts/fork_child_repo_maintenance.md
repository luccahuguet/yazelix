...
| `mars` | `raphamorim/rio` | Yazelix maintainer | Monthly while yzxterm is actively dogfooded, and before yzxterm release-gate decisions | Terminal-repo review record, plus `docs/yazelix/fork_feature_verification.md` for release evidence |
...
| `mars` | Structured experimental active-fork delta block present in the child README | Keep current during monthly yzxterm reviews |
