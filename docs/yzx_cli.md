...
yzx_repo_validator validate-child-release-transaction  # Verify locked first-party child commits are published and Cargo git source hashes match before landing a main lock update
