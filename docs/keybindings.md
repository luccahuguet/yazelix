...
| **Alt+Shift+B**          | **btm process viewer**        | opens, focuses, or closes the bundled process viewer popup |
...
- **Surface toggles**: Alt+Shift+H/J/K/L maps to left sidebar, bottom popup, top popup, and right sidebar; Alt+Shift+B opens the btm process viewer.
...
- **Zellij**:
  ...
  - `Alt+Shift+B` toggles the btm process viewer popup
