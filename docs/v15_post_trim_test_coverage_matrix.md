...
The default-suite count moved from 92 to 89 canonical tests. The old count-budget cap of 53 was stale relative to the actual suite, so it was reset to 89 after the consolidation. Future default-suite additions should again fail the budget gate unless they update the cap deliberately.
