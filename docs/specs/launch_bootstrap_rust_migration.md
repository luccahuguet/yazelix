...
| Generated runtime materialization and repair | `generated_runtime_state.nu`, `yzx_core runtime-materialization.plan`, `runtime-materialization.apply` | Keep current mixed ownership |
