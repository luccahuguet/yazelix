...
This spec describes the target contract. The current user-facing docs may still describe the existing manual Helix setup until the implementation bead lands.
