...
- Verification: manual review of
  ...
  `docs/specs/cross_language_runtime_ownership.md`; unverified long-term exit
  tracked by `yazelix-057w`
- Source: `docs/specs/cross_language_runtime_ownership.md`;
  `docs/specs/rust_migration_matrix.md`
- Related bead: `yazelix-057w`
...
- `nushell/scripts/dev/test_yzx_generated_configs.nu`,
  ...
  header `# Defends: docs/specs/test_suite_governance.md`
...
- no schema edits are required before `yazelix-rdn7.2`, `yazelix-rdn7.3`, or
  `yazelix-rdn7.5.8`

## Non-goals

- changing product code or deleting any bridge during the pilot
- backfilling every historical spec with IDs
...
- Bead: `yazelix-rdn7.7`
- Depends on: `docs/specs/canonical_contract_item_schema.md`
