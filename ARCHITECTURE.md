...
for native Nu and Starship files, lists read-only packaged bindings as a Keys
table, and exposes one hidden package-internal read path used by launch wrappers.
