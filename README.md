...
| --- | --- | --- |
| Code and configuration (Rust, Nix, shell, TOML, etc.) | **18,215 LOC** | **91,545 LOC** |
| Rust | **15,233 LOC** | **80,957 LOC** |
...
Nova owns **73,330 fewer lines**, an **80% reduction**. Classic's Rust code
...
Yazelix owns **20,561 lines** of tracked text project files. The
