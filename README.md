...
| --- | --- | --- |
| Code and configuration (Rust, Nix, shell, TOML, etc.) | **18,421 LOC** | **91,545 LOC** |
...
Nova owns **73,124 fewer lines**, an **80% reduction**. Classic's Rust code
...
Yazelix owns **20,846 lines** of tracked text project files. The
