...
| --- | --- | --- |
| Code and configuration (Rust, Nix, shell, TOML, etc.) | **20,554 LOC** | **91,545 LOC** |
| Rust | **17,457 LOC** | **80,957 LOC** |
...
Yazelix owns **23,488 lines** of tracked text project files. The
