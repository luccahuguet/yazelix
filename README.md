...
| --- | --- | --- |
| Code and configuration (Rust, Nix, shell, TOML, etc.) | **18,212 LOC** | **91,545 LOC** |
| Rust | **15,230 LOC** | **80,957 LOC** |
...
Nova owns **73,333 fewer lines**, an **80% reduction**. Classic's Rust code
...
Yazelix owns **20,558 lines** of tracked text project files. The
