...
| --- | --- | --- |
| Code and configuration (Rust, Nix, shell, TOML, etc.) | **22,679 LOC** | **91,545 LOC** |
| Rust | **19,546 LOC** | **80,957 LOC** |
...
Nova owns **68,866 fewer lines**, a **75% reduction**. Classic's Rust code
...
Yazelix owns **25,794 lines** of tracked text project files. The
