...
- `yzx refresh [--force] [--verbose]` - Refresh devenv cache/environment without launching UI (`--force` refreshes even when up to date, `--verbose` streams diagnostics and package build output)
