...
| --- | --- | --- |
| Code and configuration (Rust, Nix, shell, TOML, etc.) | **22,693 LOC** | **91,545 LOC** |
| Rust | **19,563 LOC** | **80,957 LOC** |
...
Nova owns **68,852 fewer lines**, a **75% reduction**. Classic's Rust code
...
Yazelix owns **25,810 lines** of tracked text project files. The
