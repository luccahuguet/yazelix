...
| --- | --- | --- |
| Code and configuration (Rust, Nix, shell, TOML, etc.) | **20,660 LOC** | **91,545 LOC** |
| Rust | **17,563 LOC** | **80,957 LOC** |
...
Yazelix owns **23,602 lines** of tracked text project files. The
