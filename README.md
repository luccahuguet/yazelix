...
| --- | --- | --- |
| Code and configuration (Rust, Nix, shell, TOML, etc.) | **19,312 LOC** | **91,545 LOC** |
| Rust | **16,225 LOC** | **80,957 LOC** |
...
Nova owns **72,233 fewer lines**, a **79% reduction**. Classic's Rust code
...
Yazelix owns **21,792 lines** of tracked text project files. The
