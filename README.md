...
| --- | --- | --- |
| Code and configuration (Rust, Nix, shell, TOML, etc.) | **19,292 LOC** | **91,545 LOC** |
| Rust | **16,205 LOC** | **80,957 LOC** |
...
Nova owns **72,253 fewer lines**, a **79% reduction**. Classic's Rust code
...
Yazelix owns **21,772 lines** of tracked text project files. The
