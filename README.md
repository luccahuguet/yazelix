...
| --- | --- | --- |
| Code and configuration (Rust, Nix, shell, TOML, etc.) | **22,595 LOC** | **91,545 LOC** |
| Rust | **19,472 LOC** | **80,957 LOC** |
...
Nova owns **68,950 fewer lines**, a **75% reduction**. Classic's Rust code
...
Yazelix owns **25,716 lines** of tracked text project files. The
