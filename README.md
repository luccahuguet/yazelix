...
| --- | --- | --- |
| Code and configuration (Rust, Nix, shell, TOML, etc.) | **18,221 LOC** | **91,545 LOC** |
| Rust | **15,239 LOC** | **80,957 LOC** |
...
Nova owns **73,324 fewer lines**, an **80% reduction**. Classic's Rust code
...
Yazelix owns **20,567 lines** of tracked text project files. The
