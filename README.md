...
| --- | --- | --- |
| Code and configuration (Rust, Nix, shell, TOML, etc.) | **20,674 LOC** | **91,545 LOC** |
| Rust | **17,577 LOC** | **80,957 LOC** |
...
Yazelix owns **23,618 lines** of tracked text project files. The
