...
| --- | --- | --- |
| Code and configuration (Rust, Nix, shell, TOML, etc.) | **22,600 LOC** | **91,545 LOC** |
| Rust | **19,477 LOC** | **80,957 LOC** |
...
Nova owns **68,945 fewer lines**, a **75% reduction**. Classic's Rust code
