...
| --- | --- | --- |
| Code and configuration (Rust, Nix, shell, TOML, etc.) | **22,724 LOC** | **91,545 LOC** |
| Rust | **19,594 LOC** | **80,957 LOC** |
...
Nova owns **68,821 fewer lines**, a **75% reduction**. Classic's Rust code
...
Yazelix owns **25,841 lines** of tracked text project files. The
