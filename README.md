...
| --- | --- | --- |
| Code and configuration (Rust, Nix, shell, TOML, etc.) | **23,206 LOC** | **91,545 LOC** |
| Rust | **19,810 LOC** | **80,957 LOC** |
...
Nova owns **68,339 fewer lines**, a **75% reduction**. Classic's Rust code
...
Yazelix owns **26,876 lines** of tracked text project files. The
