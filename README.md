...
| --- | --- | --- |
| Code and configuration (Rust, Nix, shell, TOML, etc.) | **22,710 LOC** | **91,545 LOC** |
...
Nova owns **68,835 fewer lines**, a **75% reduction**. Classic's Rust code
...
Yazelix owns **25,912 lines** of tracked text project files. The
