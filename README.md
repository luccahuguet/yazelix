...
| --- | --- | --- |
| Code and configuration (Rust, Nix, shell, TOML, etc.) | **23,169 LOC** | **91,545 LOC** |
...
Nova owns **68,376 fewer lines**, a **75% reduction**. Classic's Rust code
...
Yazelix owns **26,735 lines** of tracked text project files. The
