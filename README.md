...
- Made `settings.jsonc` the canonical user config, backed by `settings_default.jsonc`, JSON schema coverage, strict unknown-field diagnostics, deterministic ratconfig reconciliation, and complete Home Manager rendering
