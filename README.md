...
| --- | --- | --- |
| Code and configuration (Rust, Nix, shell, TOML, etc.) | **20,699 LOC** | **91,545 LOC** |
| Rust | **17,602 LOC** | **80,957 LOC** |
...
Yazelix owns **23,646 lines** of tracked text project files. The
