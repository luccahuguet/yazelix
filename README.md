...
| --- | --- | --- |
| Code and configuration (Rust, Nix, shell, TOML, etc.) | **20,571 LOC** | **91,545 LOC** |
| Rust | **17,474 LOC** | **80,957 LOC** |
...
Yazelix owns **23,508 lines** of tracked text project files. The
