...
<div align="center">
  ...
  <br/><br/>
  <sub><strong>v9:</strong> CLI-only environment mode (`yzx env`), health check system (`yzx doctor`), pack-based config, logo & desktop integration, flexible layouts and more!</sub>
</div>
