...
| --- | --- | --- |
| Code and configuration (Rust, Nix, shell, TOML, etc.) | **20,573 LOC** | **91,545 LOC** |
| Rust | **17,476 LOC** | **80,957 LOC** |
...
Yazelix owns **23,507 lines** of tracked text project files. The
