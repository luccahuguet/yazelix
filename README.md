...
Yazelix owns **29,046 lines** of tracked text project files. The
[reproducible scorecard](docs/development.md#loc-scorecard) excludes Beads,
lockfiles, and binary assets.
This is 1,541 lines above the pre-Rio fork surface. The current surface
...
Darwin compatibility uses cached stages; config tests create exclusively owned directories.
