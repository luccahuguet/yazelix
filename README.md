...
| --- | --- | --- |
| Code and configuration (Rust, Nix, shell, TOML, etc.) | **22,671 LOC** | **91,545 LOC** |
| Rust | **19,541 LOC** | **80,957 LOC** |
...
Nova owns **68,874 fewer lines**, a **75% reduction**. Classic's Rust code
...
Yazelix owns **25,786 lines** of tracked text project files. The
